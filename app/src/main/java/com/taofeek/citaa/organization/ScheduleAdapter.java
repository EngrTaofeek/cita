...
class ScheduleAdapter extends FirestoreRecyclerAdapter<ScheduleDataModel, com.taofeek.citaa.organization.ScheduleAdapter.ScheduleHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull com.taofeek.citaa.organization.ScheduleAdapter.ScheduleHolder holder, int position, @NonNull ScheduleDataModel model) {
        int num = position + 1;
    ...
    public ScheduleAdapter.ScheduleHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.schedule_list_item,
                parent, false);
        return new com.taofeek.citaa.organization.ScheduleAdapter.ScheduleHolder(v);
    }
